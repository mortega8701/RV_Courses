...
\TLV
   ...
   $result[31:0] = $is_andi ? $src1_value & $imm :
                   ...
                   $is_slti ? (($src1_value == $imm) ?
                             $sltui_rslt : {31'b0, $src1_value[31]}) :
                   $is_sra ? $sra_rslt :
                   $is_srai ? $srai_rslt :
                   32'b0;
   ...
   *failed = *cyc_cnt > M4_MAX_CYC;
   ...
   m4+rf(32, 32, $reset, ($rd_valid && $rd != 0), $rd[4:0], ($is_load ? $ld_data : $result[31:0]), $rs1_valid, $rs1[4:0], $src1_value[31:0], $rs2_valid, $rs2[4:0], $src2_value[31:0])
